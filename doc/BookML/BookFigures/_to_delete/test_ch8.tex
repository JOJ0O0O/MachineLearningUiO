...
% RECOMMENDED %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% envcountsame: without it svmono gives Theorem, Lemma, Proposition,
% Definition and Example five INDEPENDENT counters, so one chapter can contain
% a Theorem 12.1, a Lemma 12.1 and a Proposition 12.1 that are three different
% results.  With it they share a single sequence per chapter.
...
%% needed by the RNN unrolling and LSTM cell diagrams of Chapter 11
\usetikzlibrary{chains,positioning,fit,decorations.pathreplacing}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Theorem-like environments (used from Chapter 10 onwards).
%% svmono supplies \spnewtheorem and the [envcountchap] option numbers them
%% by chapter.  The \@ifundefined guards make this safe if a future svmono
%% release predefines any of them.
\makeatletter
\@ifundefined{theorem}{%
...
\@ifundefined{example}{%
  \spnewtheorem{example}[theorem]{Example}{\bfseries}{\rmfamily}}{}
\@ifundefined{proof}{%
